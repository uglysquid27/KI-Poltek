...
<div class="flex flex-col items-center justify-center min-h-screen space-y-5" style="font-family: 'Montserrat', sans-serif;">
    ...
    <form action="{{ route('search') }}" method="GET" class="flex items-center w-full max-w-3xl space-x-2">
        <input 
            ...
            required>
        <button type="submit" class="px-6 py-2 rounded-lg text-white bg-[#68C5CC] hover:bg-[#5bb3b8] transition duration-200">
            Cari
        </button>
    </form>

    <!-- Additional Button Below -->
    <button class="mt-2 px-6 py-2 rounded-lg text-white bg-[#E77817] hover:bg-[#e77817] transition duration-200">
       Pencarian Lanjutan
    </button>
</div>
@endsection