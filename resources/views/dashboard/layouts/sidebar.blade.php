<div class="top-0 sticky flex flex-col justify-between self-start bg-white border-e border-gray-100 w-60 h-screen"> {{-- Lebarkan dari w-16 jadi w-60 --}}
  <div>
    ...
    <div class="border-gray-100 border-t">
      <div class="px-2">
        <div class="py-4">
          ...
          >
            {{-- Dashboard Icon --}}
            <svg xmlns="http://www.w3.org/2000/svg" class="opacity-75 w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <ul class="space-y-1 pt-4 border-gray-100 border-t">
          ...
          <li>
            ...
            >
              {{-- Lightbulb Icon --}}
              <svg xmlns="http://www.w3.org/2000/svg" class="opacity-75 w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 3c3.866 0 7 3.134 7 7 0 2.387-1.118 4.505-3 5.856V18a2 2 0 01-2 2h-4a2 2 0 01-2-2v-2.144C6.118 14.505 5 12.387 5 10c0-3.866 3.134-7 7-7z" />
              </svg>
          ...
          <li>
            ...
            >
              {{-- Cube / Design Icon --}}
              <svg xmlns="http://www.w3.org/2000/svg" class="opacity-75 w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M21 16V8a2 2 0 00-1-1.732l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.732l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z" />
              </svg>
  ...
  <div class="bottom-0 sticky inset-x-0 bg-white p-2 border-gray-100 border-t">
    <a
      href="{{ route('logout') }}" {{-- Harus POST kalau pakai Laravel Auth --}}
