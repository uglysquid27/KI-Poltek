                    ...
                    <form action="{{ route('dashboard.paten.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="judul_paten" id="judul_paten" value="{{ old('judul_paten') }}" required
                                   class="w-full px-4 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[#68C5CC] text-gray-700 @error('judul_paten') border-red-500 @enderror">
                            @error('judul_paten')
                        ...
                        <div>
                            ...
                            <input type="text" name="ketua_inventor_nama" id="ketua_inventor_nama" value="{{ old('ketua_inventor_nama') }}" required
                                   class="w-full px-4 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[#68C5CC] text-gray-700 @error('ketua_inventor_nama') border-red-500 @enderror">
                            @error('ketua_inventor_nama')
                                <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                            @enderror
                        </div>
                        <div>
